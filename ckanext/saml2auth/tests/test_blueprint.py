...
class TestBlueprint(object):
    ...
    def skip_test_user_register_disabled_by_default(self, app):
    ...
    def skip_test_internal_user_login_disabled_by_deafult(self, app):
    ...
    def skip_test_came_from_sent_as_relay_state(self, app):
